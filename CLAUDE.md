# Claude configuration for `hermes-claude-code-router`

This file is loaded by Claude Code at session start. It points at the canonical context for working in this repo and lays out the engineering-journal maintenance rules. **Read the journal first if you're picking up a new session in this repo.**
